...
{PDF:WorkExperience}
{
    ...
    \begin{Detail}
    \SubBulletItem{
        Led the hardware design process of an automatic fruit testing robot targeted for agriculture industry customers.\newline Performed component research, prototyping, implementation, and testing.
    }
    \end{Detail}
}
